...
/* ADD OR REMOVE VARIABLES ACCORDING TO YOUR FORM*/
  if(formObject.RecId && checkID(formObject.RecId)){
    var values = [[formObject.RecId.toString(),
                  ...
                  formObject.jabatan,
                  formObject.cdpw,
                  formObject.jenjangAsal,
                  formObject.statusAsal,
                  formObject.npsnAsal,
                  formObject.sekolahAsal,
                  formObject.kotaAsal,
                  formObject.mapelDiampu,
                  formObject.jenjangTujuan,
                  formObject.statusTujuan,
                  formObject.npsnTujuan,
                  formObject.sekolahTujuan,
                  formObject.kotaTujuan,
                  formObject.mapelTujuan,
                  formObject.tglVerifikasi,
                  formObject.petugasVerifikasi,
                  formObject.kelengkapan,
                  formObject.keterangan,
                  formObject.notaPertimbangan]];
  }else{
...
function getRangeByID(id){
  if(id){
    ...
    for(var i=0;i<idList.length;i++){
      if(id==idList[i][0]){
        return 'MUTASI!A'+(i+2)+':'+globalVariables().lastCol+(i+2);
      }
    }
  }
}
